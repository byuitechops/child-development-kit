    ...
    return new Promise((resolve, reject) => {
        ...
        enquirer.ask()
            ...
            .then((downloadData) => {
                ...
                // return decompress(`./factory/originalZip/Conversion Test Gauntlet ${gauntletNum() + 1}.zip`, `./factory/unzipped/Conversion Test Gauntlet ${gauntletNum() + 1}`);
            })
            .then((paths) => {
